...
with c1:
    ...
    st.write("Kaggle Eye Disease Dataset kullanılmıştır. 4 farklı hastalık sınıfı ve dengeli veri dağılımı sağlanmıştır. Veri seti, Katarakt, Diyabetik Retinopati, Glokom, Normal sınıflarından oluşmaktadır.")
with c2:
